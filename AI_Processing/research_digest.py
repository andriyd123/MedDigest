...
SYSTEM_ROLE = """
You are an expert medical research analyst specializing in synthesizing insights from multiple research papers.
Your task is to analyze batches of medical research papers and provide comprehensive insights that highlight:
- Key findings and their clinical significance
- Emerging trends across multiple studies
- Cross-specialty implications and connections
- Potential impact on medical practice and patient care
Provide detailed, professional analysis that can be used in medical newsletters and research summaries.
"""
...
class ResearchDigest:
    ...
    def __init__(self, api_key: str):
        ...
        self.analyzer = PaperAnalyzer(api_key, self.token_monitor)
    ...
    def _batch_analyze_papers(self, specialty_data: Dict[str, Dict]) -> None:
        ...
        for i in range(0, total_papers, 10):
            ...
            try:
                ...
                batch_analysis = json.loads(response_content)
                ...
                # Record token usage for digest summary
                input_text = SYSTEM_ROLE + prompt
